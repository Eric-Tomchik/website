...
export default function POSGuideContent() {
  return (
    <div className="space-y-20">
      {/* Intro */}
      <div className="space-y-4">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white">The Complete POS Systems Guide</h2>
        <p className="text-lg text-surface-300 leading-relaxed max-w-3xl">
          POS platforms change pricing, update processing rates, and modify contract terms regularly. State surcharge laws evolve too. This companion page keeps the comparison tables and legal reference accurate and up-to-date.
        </p>
